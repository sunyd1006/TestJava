 ...
 * 	at com.java.debug.DebugDemo.test(DebugDemo.java:11)         // 再看这里 2
 * 	at com.java.debug.DebugDemo.main(DebugDemo.java:21)         // 先看这里 1
 *
 * ERROR DebugDemo ExceptionTest Exception: 后打印的错误
 *  java.lang.ArithmeticException: / by zerow
 * 	at com.java.debug.DebugDemo.test(DebugDemo.java:11)
 * 	at com.java.debug.DebugDemo.main(DebugDemo.java:21)
 */
